              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="mb-[22px]">
                  ...
                  <p className="text-xs mt-2">
                    Ensure that the document contains your transaction history for accurate analysis.
                  </p>
                </div>
                <div className="mb-9">
                  <button
                ...
                <div>
                  ...
                  <p className="text-sm">
                    By uploading your bank statement, you consent to Tuzawise processing your data for the purpose of providing personalized financial insights. Tuzawise adheres to strict data privacy and security standards to protect your information.
                  </p>
                </div>
              </form>
